...
public class MainWin extends JFrame {
    ...
    public MainWin() {
        ...
        JMenuItem customerandview = new JMenuItem("Customer");
        ...
        customerandview.addActionListener(event -> onCreateCustomerClick());
    ...
    protected void onCreateCustomerClick(){
        try{
            ...
            Object[] names = emporium.customers();
            JComboBox<Object> types = new JComboBox<>(names);
            ...
            int button = JOptionPane.showConfirmDialog( // Show the dialog
                        ...
                        emporium.addcustomer(new Customer(temp,phones.getText()));
                        }
        } catch(Exception e) {
